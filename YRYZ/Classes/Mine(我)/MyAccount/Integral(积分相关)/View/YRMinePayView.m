...
@end
static YRMinePayView *paymentView = nil;

@implementation YRMinePayView
...
+ (YRMinePayView *)sharedPaymentView
{
    static dispatch_once_t predicate;
    dispatch_once(&predicate, ^{
        paymentView = [[YRMinePayView alloc]initWithFrame:CGRectMake(0, 0,  SCREEN_WIDTH , SCREEN_HEIGHT)];
...
{
    [[YRMinePayView sharedPaymentView] showPaymentPasswordView];
    [[YRMinePayView sharedPaymentView] refreshDataWithMoney:money];
    [YRMinePayView sharedPaymentView].paymentBlock = paymentBlock;
}


+ (void)hidePaymentPasswordView{
    
    [[YRMinePayView sharedPaymentView] hidePaymentPasswordView];
...
-(void)refreshDataWithMoney:(NSString*)money{
    ...
    NSString *moneyString = [NSString stringWithFormat:@"%@",money];
