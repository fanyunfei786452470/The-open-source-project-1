...
- (instancetype)initWithDefaultDatetime:(NSDate *)dateTime
{
    ...
    if (self) {
        ...
        [self setTimeBroadcastViewWithTitle:@""];
    }
    return self;
}
...
- (instancetype)initWithDatePickerMode:(DatePickerMode)datePickerMode defaultDateTime:(NSDate *)dateTime withTitle:(NSString *)title{
    ...
    if (self) {
        ...
        self.datePickerMode = datePickerMode;
        [self setTimeBroadcastViewWithTitle:title];
    }
    return self;
}
...
//设置自定义datepicker界面
- (void)setTimeBroadcastViewWithTitle:(NSString *)title
{
    ...
    topView.backgroundColor = [UIColor themeColor];//[UIColor colorWithHexString:@"0x6271f3"];
