...
-(void)initUI{
    @weakify(self);
    _redPaperReceiveView = [[YRRedPaperReceiveView alloc]initWithFrame:CGRectMake(0, 64, SCREEN_WIDTH, SCREEN_HEIGHT - 64)];
    _redPaperReceiveView.lookRecordBlock = ^{
        @strongify(self);
        YRRedPaperRecordViewController *redPaperRecordViewController = [[YRRedPaperRecordViewController alloc]init];
        [self.navigationController pushViewController:redPaperRecordViewController animated:YES];
    };
