...
@interface YRReportTextView ()

-(void)refreshPlaceholder;

@end

@implementation YRReportTextView
{
...
//        NSTextContainer *textContainer = [[NSTextContainer alloc] initWithSize:CGSizeMake(frame.size.width, 100)];
