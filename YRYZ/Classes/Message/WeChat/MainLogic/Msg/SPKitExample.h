...
typedef void(^DidHeadImgBlock)(void);
...
@property (nonatomic,assign) NSInteger isGroupChat;

@property (nonatomic,strong) YWTribe *aTribe;
@property (nonatomic,strong) YWPerson *aPerson;
@property (nonatomic,strong) YWConversation *conversation;

@property (nonatomic,copy) DidHeadImgBlock seleteHeadImg;
