...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSDictionary *dic = self.giftListArr[indexPath.row];
    NSInteger count = [dic[@"count"] integerValue];
    
    cell.countLab.text = [NSString stringWithFormat:@"×%ld",count];
    [cell.iconImg setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",dic[@"gitfimg"]]] placeholder:[UIImage imageNamed:@"testImage"]];
