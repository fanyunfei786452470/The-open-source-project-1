...
//        self.backgroundColor = [UIColor whiteColor];
        ...
        YRAVPlayerView *avPlayer = [[YRAVPlayerView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT) IsRequest:isRequest WithPathOrUrl:pathOrUrl];
