...
-(float)heightForString:(NSString *)value fontSize:(float)fontSize{
    ...
    CGSize size = [value boundingRectWithSize:CGSizeMake(SCREEN_WIDTH-70, CGFLOAT_MAX) options: NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:attribute context:nil].size;
