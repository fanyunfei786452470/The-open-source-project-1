...
- (void)configHeader{
    ...
    // 指定为拉伸模式，伸缩后重新赋值
    image.image = [image.image resizableImageWithCapInsets:insets resizingMode:UIImageResizingModeStretch];
...
- (void)configUITbable:(UILabel *)label{
    ...
    UITableView *table = [[UITableView alloc]initWithFrame:CGRectMake(10, 50, SCREEN_WIDTH-70-10, self.num*44) style:UITableViewStylePlain];
    if (self.num<4) {
...
//    cell.title.text = str3;
    ...
    cell.title.text = str;
     cell.title2.textColor = [UIColor whiteColor];
    cell.title2.text = str2;
