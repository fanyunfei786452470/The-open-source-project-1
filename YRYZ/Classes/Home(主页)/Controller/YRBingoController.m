...
- (void)configHeader{
    ...
    YRBeforePrizeModel *modelS1 = self.model.list.firstObject;
    YRBeforePrizeModel *modelS2 = self.model.list.firstObject;
    ...
    NSMutableAttributedString *attributedString4 = [[NSMutableAttributedString alloc]initWithString:text4];
    ...
    if (self.num==0) {
        ...
        NSMutableAttributedString *att= [[NSMutableAttributedString alloc]initWithString:names];
