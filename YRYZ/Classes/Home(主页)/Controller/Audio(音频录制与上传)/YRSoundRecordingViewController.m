...
#define kRecordAudioFile @"myRecord.mp4"
...
@interface YRSoundRecordingViewController ()<AVAudioRecorderDelegate>
...
-(void)nextStepAction{
    ...
    soundUploadViewController.dataSource = self.dataSource;
    soundUploadViewController.audioPath = urlStr;
    soundUploadViewController.audioTime = self.timeLabel.text;
    [self.navigationController pushViewController:soundUploadViewController animated:YES];
}
