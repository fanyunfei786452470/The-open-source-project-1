...
- (void)layoutSubviews {
    ...
    self.zanBtn.frame = CGRectMake(5, -5, self.menuView.frame.size.width/3-10, 30);
    self.giftBtn.frame = CGRectMake(self.menuView.frame.size.width/3+5, -5, self.menuView.frame.size.width/3-10, 30);
    self.commentBtn.frame = CGRectMake(self.menuView.frame.size.width/3*2+5, -5, self.menuView.frame.size.width/3-10, 30);
    
    self.moreCommentBtn.frame = self.cellLayout.moreCommentRect;
    
    self.layerOne.frame = CGRectMake(self.menuView.frame.size.width/3, 0, 0.5, 20);
    self.layerTwo.frame = CGRectMake(self.menuView.frame.size.width/3*2, 0, 0.5, 20);
    ...
    if (_cellLayout.statusModel.custId == [YRUserInfoManager manager].currentUser.custId) {
...
- (UIButton *)deleteBtn{
    ...
    _deleteBtn.titleLabel.font = [UIFont systemFontOfSize:13.f];
...
- (UIButton *)moreCommentBtn{
    ...
    _moreCommentBtn.backgroundColor = RGB_COLOR(245, 245, 245);
