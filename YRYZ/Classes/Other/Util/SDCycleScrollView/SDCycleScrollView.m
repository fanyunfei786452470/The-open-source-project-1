    ...
    if (self.isMineAnimation) {
        ...
        if (!self.onlyDisplayText && [imagePath isKindOfClass:[NSString class]]) {
            if ([imagePath hasPrefix:@"http"]) {
                ...
                [cell.animationView setImageWithURL:[NSURL URLWithString:imagePath] placeholder:self.placeholderImage];
            } else {
                YYImage *image = [YYImage imageNamed:imagePath];
                if (!image) {
                    [YYImage imageWithContentsOfFile:imagePath];
                }
                cell.animationView.image = image;
            }
        } else if (!self.onlyDisplayText && [imagePath isKindOfClass:[UIImage class]]) {
            cell.animationView.image = (UIImage *)imagePath;
        }
