...
-(float)heightForStringfontSize:(float)fontSize{
    ...
    CGSize size = [self boundingRectWithSize:CGSizeMake(SCREEN_WIDTH-20, CGFLOAT_MAX) options: NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:attribute context:nil].size;
...
-(float)heightForStringfontSize1:(float)fontSize{
    ...
    CGSize  size1 = [self sizeForFont:[UIFont systemFontOfSize:fontSize] size:CGSizeMake(SCREEN_WIDTH-20, CGFLOAT_MAX) mode:NSLineBreakByWordWrapping];
    return size1.height;
